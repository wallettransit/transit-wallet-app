                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: [
                            Center(
                              child: Icon(Icons.map, size: 100, color: AppColors.kekeGreen.withOpacity(0.5)),
                            ),
                            Positioned(
                              top: 16,
                              left: 16,
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.flash_on, color: AppColors.kekeGreen, size: 16),
                                    const SizedBox(width: 6),
                                    Text(
                                      'Instant Payments',
                                      style: AppTypography.label.copyWith(
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Join thousands of riders in Lagos, Abuja, and Ibadan navigating Nigerian roads smarter, paying digital fares instantly.',
